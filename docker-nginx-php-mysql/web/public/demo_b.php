      ...
      <div class="wrapper" style="margin-left: 30px; width: 75%"><!--右選單-->
        ...
        >
          ...
          <form
           id = "TD3-LSTM"
            class="form"
            action="data_collection_b.php?model_type=TD3-LSTM&agent_num=60"
            method="post"
            style="align-self: flex-end"
          >
            <button type="submit" name="button" class="agent_choosen" style='border:2px solid white;border-radius:8px;padding:10px;box-shadow: 8px 4px 0px white;'>
        ...
        <script>
          function change_1() {
            ...
            fo.action = `data_collection_b.php?model_type=TD3-LSTM&agent_num=${number}`
          }
          function change_2() {
            let number = Math.floor(Math.random() * 300);
            ...
            fo.action = `data_collection_b.php?model_type=A3C-LSTM&agent_num=${number}`
          }
          function change_3() {
            let number = Math.floor(Math.random() * 300);
            ...
            fo.action = `data_collection_b.php?model_type=PPO-LSTM&agent_num=${number}`
          }
        </script>
      </div>
    </div>
