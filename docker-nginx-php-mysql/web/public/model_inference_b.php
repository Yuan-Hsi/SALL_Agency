...
.material{
  ...
  <body bgcolor="EDEDED" style="margin-left: 120px; margin-right: 120px">
    ...
    <h1 style='font-weight:700;margin-top:2.5%;color:#874b01;'>Main Functions of Inference</h1>
    ...
    <div style= 'display:flex;align-items:center;'>
      ...
      <h1 class ='unprogress_name' style='background:white;color: #cd9839;border-color:#a16d2c'>Inference</h1>
      <div class = 'unprogress_content'>
        <p style='font-weight:600;margin-top:2%'> Using the input you think is reasonable to inference.</p>
      </div></div>
      </div>
      <div class="arrow"></div>
      ...
      <div style="margin-right:30px;display: flex;align-items:center;flex-direction:column">
       <h1 class ='unprogress_name' style='background:white;color: #cd3939;border-color:#af1a1a'>Inference</h1> 
      <div class="unprogress_content">
    ...
    -->
      ...
      <h1 class ='unprogress_name' style='background:white;color: #1e89a1;border-color:#4773ab'>Backtest</h1></div>
      <div class="unprogress_content" style="display:flex;justify-content:center;">
      <p style='font-weight:600;margin-top:2%'> Backtest the recent 50 days for this policy.</p>
