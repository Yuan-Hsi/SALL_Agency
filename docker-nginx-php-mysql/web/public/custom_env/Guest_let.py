    def step(self, action):
        ...
        * Continuous Integration - This help your code can be test for a whole run in the data you selected when you press SAVE.
        * Share with your team - In the scrool beyond this section, you are copy other agent's reward thinking and edit in your own agent.
        ...
        # THE SENERIO CAN NOT BUY A STOCK
                else:
                    self.hold = True
